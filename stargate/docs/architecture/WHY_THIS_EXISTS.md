...
If we can't explain *why* a piece of code exists in the `stargate/index.yaml`, it has no right to be in the `app/`.
...
- **Index**: `stargate/index.yaml` (The Table of Contents)
